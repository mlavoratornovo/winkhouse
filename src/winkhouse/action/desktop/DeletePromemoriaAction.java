		...
		if (dv.getDesktop_type() == DesktopView.PROMEMORIA_TYPE){
			...
			try {
				...
				MessageDialog.openError(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(),
										...
										"Si � verificato un errore durante la cancellazione dei promemoria");
			}
...
//									  "La funzione di cancellazione non � disponibile in modalit� struttura, \n per pulire la scrivania passare alla modalit� promemoria e poi ritornare in modalit� struttura");			
