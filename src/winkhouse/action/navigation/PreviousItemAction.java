...
public class PreviousItemAction extends Action {

	public static String ID = "winkhouse.previousitemaction";

	public PreviousItemAction(String text, ImageDescriptor image) {
		super(text, image);
		setId(ID);
	}
