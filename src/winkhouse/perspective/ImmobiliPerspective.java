...
public class ImmobiliPerspective implements IPerspectiveFactory {

	public final static String ID = "winkhouse.immobili";
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		IFolderLayout fldettaglioimmobile = layout.createFolder("dettaglioimmobile", IPageLayout.RIGHT, 0.25f, ImmobiliTreeView.ID);
		fldettaglioimmobile.addPlaceholder(DettaglioImmobileView.ID);
		fldettaglioimmobile.addPlaceholder(DettaglioImmobileView.ID+":*");
		fldettaglioimmobile.addPlaceholder(DettaglioColloquioView.ID);
		fldettaglioimmobile.addPlaceholder(DettaglioColloquioView.ID+":*");
		fldettaglioimmobile.addPlaceholder(DettaglioAnagraficaView.ID);
		fldettaglioimmobile.addPlaceholder(DettaglioAnagraficaView.ID+":*");
		
		IFolderLayout fldatiimmobile = layout.createFolder("datiimmobile", IPageLayout.BOTTOM, 0.8f, "dettaglioimmobile");
