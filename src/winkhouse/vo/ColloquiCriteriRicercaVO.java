...
public class ColloquiCriteriRicercaVO implements Serializable{
	...
	/**
	 * Il nome del metodo di get che verr� invocato per ottenere il valore che rappresenta il campo della classe
	...
	/**
	 * Operatore logico con il quale verr� concatenata la condizione di ricerca (AND/OR)
	 * @return
	 */
	...
	/**
	 * Se fromValue � valorizzato rappresenta il valore di fine entro il quale cercare il valore generato dall'invocazione
