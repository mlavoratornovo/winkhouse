...
//		gdDes.grabExcessVerticalSpace = true;
	...
	private void bindDatiReport(DataBindingContext bindingContext){
		...
		bindingContext.bindValue(SWTObservables.observeText(tDescrizione,SWT.Modify), 
								 PojoObservables.observeValue(report, "descrizione"),
								 null, 
								 null);
		
		bindingContext.bindValue(SWTObservables.observeText(tNome,SWT.Modify), 
								 PojoObservables.observeValue(report, "nome"),
								 null, 
								 null);
