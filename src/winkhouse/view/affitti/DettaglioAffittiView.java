...
public class DettaglioAffittiView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		cvagenteinseritoreanagrafica = new ComboViewer(f.getBody());
...
//		});
	...
	private void bindAffitto(DataBindingContext bindingContext){
		...
		bindingContext.bindValue(SWTObservables.observeText(cauzione,SWT.Modify), 
								 PojoObservables.observeValue(affitto, "cauzione"),
								 uvsToText, 
								 uvsToModel);

		bindingContext.bindValue(SWTObservables.observeText(rata,SWT.Modify), 
								 PojoObservables.observeValue(affitto, "rata"),
								 uvsToText, 
								 uvsToModel);
