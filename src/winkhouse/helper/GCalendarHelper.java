			...
			while (it.hasNext()){
				...
				if (!gcDAO.saveUpdate(gcal, null, true)){
					...
					MessageDialog.openError(Activator.getDefault().getWorkbench().getActiveWorkbenchWindow().getShell(),
											...
											"Si � verificato un errore nel salvataggio indirizzo calendario : " + 
											gcal.getPrivateUrl());
				}
			}
		}
	...
	public void synchAppuntamentiToGCalendar(int type, Date startSync, Date endSync, Shell s, ArrayList<AgenteResult> returnValue){
		...
		try {
			...
			MessageBox mb = new MessageBox(winkhouse.Activator
													  ...
													  .getShell(),
													  SWT.ICON_ERROR);
			mb.setText("Si � verificato un errore nella sincronizzazione");
			mb.setMessage("Si � verificato un errore nella sincronizzazione degli appuntamenti di winkhouse \n" +
