...
public class AnagraficheHelper {
			...
			if (anagrafica != null){
				...
				if (!anagraficheDAO.saveUpdate(anagrafica, con, doCommit)){
					...
					MessageDialog.openError(Activator.getDefault().getWorkbench().getActiveWorkbenchWindow().getShell(),
											...
											"Si � verificato un errore nel salvataggio dell'anagrafica : " + 
	...
	private ContattiModel checkContattoDB(ContattiModel cModel){
		if (cModel.getCodContatto() != 0){
			if (new ContattiDAO().getContattoById(ContattiVO.class.getName(), cModel.getCodContatto()) == null){
				MessageDialog.openError(PlatformUI.getWorkbench()
						     					  ...
						     					  .getShell(),
						     			"ERRORE", 
										"Il contatto che si sta cercando di aggiornare � stata cancellata da un altro utente");
				cModel = null;
		...
		/*		if (MessageDialog.openConfirm(PlatformUI.getWorkbench()
														...
														.getShell(), 
											  "ATTENZIONE", 
											  "Si sta cercando di aggiornare il contatto " + cModel.toString() + " gi� cancellato da un altro utente. \n" +
											  "Se si prosegue con l'operazione li contatto verr� inserito nella base dati." +
		...
		if ((aModel.getCodAnagrafica()!= null) && (aModel.getCodAnagrafica() != 0)){
			...
			if (aDAO.getAnagraficheById(AnagraficheVO.class.getName(), aModel.getCodAnagrafica()) == null){
				MessageDialog.openError(PlatformUI.getWorkbench()
												  ...
												  .getShell(),
										"ERRORE", 
										"L'anagrafica che si sta cercando di aggiornare � stata cancellata da un altro utente");
				aModel = null;
			}
