...
//		filtraRicerche.setBackground(new Color(null,255,255,255));
		filtraRicerche.setImage(Activator.getImageDescriptor("/icons/kfind.png").createImage());
	...
	class ViewContentProvider implements IStructuredContentProvider{
		...
		public Object[] getElements(Object inputElement) {
			return ricercheDAO.getRichercheByTipo(RicercheModel.class.getName(), idTipoRicerca).toArray();
		}
