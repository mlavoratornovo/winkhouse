	...
	private void bindCommenti(DataBindingContext bindingContext){
		...
		if (((ColloquiWizard)getWizard()).getColloquio() != null){
			...
			bindingContext.bindValue(SWTObservables.observeText(
									 tVarieAgenzia,SWT.Modify), 
									 PojoObservables.observeValue(((ColloquiWizard)getWizard()).getColloquio(), "commentoAgenzia"),
									 null, 
									 null);

			bindingContext.bindValue(SWTObservables.observeText(
									 tVarieCliente,SWT.Modify), 
									 PojoObservables.observeValue(((ColloquiWizard)getWizard()).getColloquio(), "commentoCliente"),
									 null, 
									 null);
