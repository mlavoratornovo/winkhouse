	...
	private void bindDatiComuni(DataBindingContext bindingContext){
		...
		if (((ColloquiWizard)getWizard()).getColloquio() != null){
			...
			bindingContext.bindValue(SWTObservables.observeText(
									 ...
									 PojoObservables.observeValue(((ColloquiWizard)getWizard()).getColloquio(), "descrizione"),
									 null, 
									 null);

			bindingContext.bindValue(SWTObservables.observeText(
									 tLuogo,SWT.Modify), 
									 PojoObservables.observeValue(((ColloquiWizard)getWizard()).getColloquio(), "luogoIncontro"),
									 null, 
									 null);
