...
//												  "La password è stata salvata in formato criptato");
//
//				}else{
//					MessageDialog.openError(s,
//							  				"Salvataggio password Google", 
//							  				"Si è verificato un errore la password non è stata salvata");					
//				}
			}
	...
	*/
	private void bindGData(DataBindingContext bindingContext){
		...
		bindingContext.bindValue(SWTObservables.observeText(
													tpassword,SWT.Modify
															), 
								 PojoObservables.observeValue(gdM, "pwsKey"),
								 null, 
								 null);
	}
