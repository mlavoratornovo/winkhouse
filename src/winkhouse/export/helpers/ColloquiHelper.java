...
public class ColloquiHelper {
	 ...
	 * 
	 * controllando tra colloqui in cui � presente l'anagrafica passata in input 
	 ...
	 * Se il campo codColloquio, del parametro colloquio, � zero viene inserito un nuovo record, altrimenti esegue una operazione
	 * SQL di update.
	...
	*/
	 ...
	 * Se il campo codColloquioAgenti, del parametro colloquiagenti, � zero viene inserito un nuovo record, altrimenti esegue una operazione
	 * SQL di update.
	 * Se durante l'operazione avviene un errore viene ritornata una eccezione di tipo java.sql.SQLException 
	 * 
	...
	*/
	...
	/**
	 * Inserisce un record nella tabella colloquiagenti ritornando true o false.
	 * Se il campo codColloquioAnagrafica, del parametro colloquianagrafiche, � zero viene inserito un nuovo record, altrimenti esegue una operazione
	 * 
	 * SQL di update.
	 * Se durante l'operazione avviene un errore viene ritornata una eccezione di tipo java.sql.SQLException 
	 * 
	...
	*/
	 ...
	 * Se il campo codAllegatiColloqui, del parametro allegatiColloqui, � zero viene inserito un nuovo record, altrimenti esegue una operazione
	 * 
	 * SQL di update.
	 * Se durante l'operazione avviene un errore viene ritornata una eccezione di tipo java.sql.SQLException 
	 * 
	...
	*/
	 ...
	 * Se il campo codColloquioCriterioRicerca, del parametro colloquiCriteriRicerca, � zero viene inserito un nuovo record, altrimenti esegue una operazione
	 * 
	 * SQL di update.
	 * Se durante l'operazione avviene un errore viene ritornata una eccezione di tipo java.sql.SQLException 
	 * 
